...
import { AddGrupoDialog } from "./add-grupo-dialog";

export function GruposMaterialContent() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Organize seus materiais em grupos para melhor controle
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Grupos Vazios</CardTitle>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Visualize e gerencie todos os grupos de materiais
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <GruposTable searchTerm={searchTerm} />
        </CardContent>
      </Card>
